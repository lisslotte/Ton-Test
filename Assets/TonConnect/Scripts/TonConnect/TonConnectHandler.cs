...
public class TonConnectHandler : MonoBehaviour
{
    ...
    [HideInInspector] public delegate void OnProviderStatusChange(TonSdk.Connect.Wallet wallet);
    ...
    private void OnStatusChange(TonSdk.Connect.Wallet wallet) => OnProviderStatusChanged?.Invoke(wallet);
